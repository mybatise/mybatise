 ...
 * @author Wes Lin
 */
public class SupportGenerator implements FilesGenerator {
    @Override
    public void generate(TemplateFilesCreator filesCreator, MappingContext context, EntityDefinition definition) {
        ...
        Map<String, Object> dataModel = dataModelMapper.mapSupport(context, definition);
        filesCreator.creat(context, TemplateType.SUPPORT, dataModel);
    }
}
